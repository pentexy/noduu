...
# Bot configuration
BOT_TOKEN = "8323706303:AAF3TP5MC2ImV7Po-vd4sNZXJDNUuihNaM4"  # Replace with your token
DEFAULT_WEBHOOK_URL = "https://discord.com/api/webhooks/13588761041/-5MqmNYtm71bGnyH7Q5uxOcX"  # Replace
TELEGRAM_CHANNEL_ID = "-1002811571737"  # Replace with your channel ID
PREMIUM_USERS = [7339063037]  # Replace with your Telegram user ID
...
@bot.message_handler(func=lambda message: message.text in [
    ...
    "Run Main Swap", "BackUp Mode", "Threads Swap", "Webhook", "Bio", "Name", "Back", "Stop KORN"
])
